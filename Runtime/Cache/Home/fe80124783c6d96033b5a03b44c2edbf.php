...
<body>
    ...
    <section class="main">
        ...
        <div class="bgf detail-wrap">
            <div class="item-head">
                <h1 class="fs15 col3"><?php echo ($data_info["title"]); ?></h1>
                <div class="clearfix mt5 fs12 col9">
                    <span><?php echo ($data_info["time"]); ?></span>
                </div>
            </div>
            <article class="mt10 fs13 col6 m-editor">
