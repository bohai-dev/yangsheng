...
<?php else: ?>
                ...
                $(function(){
                    ...
                    $(document).on('click', '#<?php echo ((isset($group_k) && ($group_k !== ""))?($group_k):''); ?>_upload_list_<?php echo ($k); ?> .remove-picture', function() {
                        ...
                        $('#<?php echo ((isset($group_k) && ($group_k !== ""))?($group_k):''); ?>_upload_preview_<?php echo ($k); ?>').addClass('hidden');
                                ...
                                <?php case "picture_crop": ?><script src="/Public/libs/layer/layer.js"></script>
    <script src="/Public/libs/cropper/cropper.js"></script>
    <link rel="stylesheet" href="/Public/libs/cropper/cropper.css">
                ...
                $(function(){
                    KindEditor.ready(function(K) {
                        kindeditor_<?php echo ($k); ?> = K.create('#<?php echo ((isset($group_k) && ($group_k !== ""))?($group_k):''); ?>_kindeditor_<?php echo ($k); ?>', {
                            ...
                            filePostName : 'file',
                            cssPath : [
                                '/Public/libs/lyui/dist/css/lyui.min.css',
	...
	{	
        ...
        <div class="right">
            ...
            <link rel="stylesheet" href="/Public/libs/jquery-asDatepicker/css/asDatepicker.css">
            <link rel="stylesheet" href="/Public/libs/jquery-asDatepicker/css/corethink.css">
            <script type="text/javascript" src="/Public/libs/jquery-asDatepicker/dist/jquery-asDatepicker.js"></script>
            <script type="text/javascript">
                $(function(){
