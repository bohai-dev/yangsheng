...
$_config = array(
    ...
    'ALIPAY_CONFIG'          => array(
        ...
        'seller_id' => '', //收款支付宝账号
        'key' => '', //key
        'private_key_path' => XILUDomain(). __ROOT__ . '/Framework/Library/Vendor/Alipay/key/rsa_private_key.pem', //商户私钥
        'ali_public_key_path' => XILUDomain(). __ROOT__ . '/Framework/Library/Vendor/Alipay/key/alipay_public_key.pem', //支付宝公钥
    ...
    'COMPANY_NAME'    => '上海西陆信息科技有限公司',     // 公司名称
    'COMPANY_EMAIL'   => 'admin@lingyun.net',            // 公司邮箱
    'DEVELOP_TEAM'    => '上海西陆信息科技有限公司',     // 当前项目开发团队名称
