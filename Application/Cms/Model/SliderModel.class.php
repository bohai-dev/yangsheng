...
class SliderModel extends Model {
    ...
    protected $_validate = array(
        ...
        array('cover', 'require', '图片不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('type', 'require', '分类不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
    );
    ...
    public function getList($limit = 10, $page = 1, $order = null, $map = null) {
       ...
       $slider_list = $this->page($page, $limit)->order($order)->where($map)->select();
        return $slider_list;
    }
