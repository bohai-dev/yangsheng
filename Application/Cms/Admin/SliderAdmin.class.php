...
class SliderAdmin extends AdminController {
    ...
    public function index() {
        ...
        $builder->setMetaTitle('幻灯列表')  // 设置页面标题
                ...
                ->addTableColumn('type', '分类','callback',[$slider_object,'getTypeText'])
    ...
    public function add() {
        ...
        if (IS_POST) {
            ...
            $builder->setMetaTitle('新增幻灯')  // 设置页面标题
                    ...
                    ->addFormItem('cover', 'picture', '图片', '图片最佳尺寸：750*400px')
                    ->addFormItem('type', 'select', '分类', '',$slider_object->typetext)
