...
class UserModel extends Model
{
    ...
    protected $_validate = array(
        // 验证用户类型
        array('user_type', 'require', '请选择用户等级', self::MUST_VALIDATE, 'regex', self::MODEL_INSERT),

        //验证用户名
        array('nickname', 'require', '用户姓名不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),


        // 验证手机号码
        array('mobile', 'require', '手机号不能为空', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
        array('mobile', '/^(0|86|17951)?(13[0-9]|15[012356789]|1[78][0-9]|14[57])[0-9]{8}$/', '手机号格式不正确', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
