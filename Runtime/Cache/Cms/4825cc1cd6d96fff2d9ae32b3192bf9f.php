...
<body class="<?php echo ($_page_name); ?>">
    ...
    <div class="col-xs-2">
        <link rel="stylesheet" type="text/css" href="/Public/libs/ztree/css/metroStyle/metroStyle.css">
...
<script type="text/javascript" src="/Public/libs/ztree/js/jquery.ztree.all-3.5.min.js" charset="utf-8"></script>
    ...
    <div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra_class"]); ?>">
        ...
        <script type="text/javascript">
            $(function(){
                ...
                <?php case "dateranger": ?><link rel="stylesheet" href="/Public/libs/bootstrap-daterangepicker/daterangepicker.css">
    <style>
        .dateranger{
            width: 190px !important;
        }
    </style>
    <script src="/Public/libs/bootstrap-daterangepicker/moment.min.js"></script>
    <script src="/Public/libs/bootstrap-daterangepicker/daterangepicker.js"></script>
